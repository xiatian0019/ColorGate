...
//  CSVideoADSDK
//
//  Created by CocoaChina_yangjh on 15/1/8.
...
// 视频广告展现成功，即开始播放视频广告
- (void)csVideoADShowVideoADSuccess:(CSVideoAD *)csVideoAD;
...
// 视频广告播放完成（广告不会自动关闭）
- (void)csVideoADPlayVideoADFinished:(CSVideoAD *)csVideoAD;
